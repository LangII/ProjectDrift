...
func _ready():
    ...
    $LowerLeft/VBoxContainer/HBoxContainer/VBoxContainer/HealthHBox/PanelContainer/HealthValue.text = " %.2f " % health_input
    ...
    $UpperLeft/VBoxContainer/Objective/PanelContainer/Divider/ObjectiveValue.text = str(objective_input)
    $UpperLeft/VBoxContainer/Objective/ObjectiveProgBar.max_value = objective_input
    $UpperLeft/VBoxContainer/Objective/ObjectiveProgBar.value = objective_input
...
func updateFocusNameValue(_value, _max_health):
    ...
    $UpperLeft/VBoxContainer/FocusHealth/FocusHealthProgBar.max_value = _max_health
...
func updateFocusHealthValue(_value):
    ...
    if focus_health_input:
        ...
        $UpperLeft/VBoxContainer/FocusHealth/PanelContainer/Divider/FocusHealthValue.text = "%.2f" % focus_health_input
        $UpperLeft/VBoxContainer/FocusHealth/FocusHealthProgBar.value = _value
        
        
    else:
        focus_health_value.text = focus_health_input
        
        $UpperLeft/VBoxContainer/FocusHealth/PanelContainer/Divider/FocusHealthValue.text = focus_health_input
        $UpperLeft/VBoxContainer/FocusHealth/FocusHealthProgBar.value = 0
...
func updateObjectiveValue(_value):
    ...
    $UpperLeft/VBoxContainer/Objective/PanelContainer/Divider/ObjectiveValue.text = str(objective_input)
    $UpperLeft/VBoxContainer/Objective/ObjectiveProgBar.value = _value
